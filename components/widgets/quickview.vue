            ...
            <div class="row quickview-modal">
              <div class="col-lg-6 col-12">
                <div class="quick-view-img">
                  <swiper class="swiper-wrapper">
                    <swiper-slide
                      class="swiper-slide"
                      v-for="(imag, index) in productData.images"
                      :key="index"
                    >
                      <img
              ...
              <div class="col-lg-6 rtl-text">
                <div class="product-right">
                  ...
                  <h3 v-else>
                    {{ (productData.price * curr.curr).toFixed(2) }}
                  </h3>
                  <ul
                    class="color-variant"
                    v-if="productData.variants[0].color"
                  >
                    <li
                  ...
                  <div
                    ...
                    v-if="productData.variants[0].size"
                  >
                    <h6 class="product-title">select size</h6>
                    <div class="size-box">
                      <ul>
                        <li
                          v-for="(variant, variantIndex) in Size(
                            productData.variants
                          )"
                          :key="variantIndex"
                        >
