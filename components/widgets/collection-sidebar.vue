    ...
    <div class="collection-filter" :class="filter ? 'openFilterbar' : ''">
      ...
      <div class="collection-filter-block">
        ...
        <div class="collection-collapse-block open" v-if="filterbyBrand.length">
          ...
          <div
            class="collection-collapse-block-content"
            :style="{ display: live1 ? 'block' : 'none' }"
          >
            <div class="collection-brand-filter">
              <div
              ...
              >
                ...
                />
                <label class="form-check-label" v-bind:for="brand">{{
                  brand
                }}</label>
              </div>
            </div>
        ...
        <div class="collection-collapse-block open" v-if="filterbycolor.length">
          ...
          <div
            class="collection-collapse-block-content"
            :style="{ display: live2 ? 'block' : 'none' }"
          >
        ...
        <div class="collection-collapse-block border-0 open">
          ...
          <div
            class="collection-collapse-block-content"
            :style="{ display: live4 ? 'block' : 'none' }"
          >
      ...
      <div class="theme-card">
        ...
        <div class="offer-slider slide-1">
          ...
          >
            ...
            <swiper-slide
              class="swiper-slide"
              v-if="getCategoryProduct('new products').length >= 4"
            >
              <div>
                <div
                  class="media"
