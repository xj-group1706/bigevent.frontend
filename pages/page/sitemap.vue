    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-6">
          ...
          <ul class="">
            <li>
              <a href="category-page.html"> New demos</a>
              <ul>
                <li><a target="_blank" href="tools.html">tools</a></li>
                <li>
                  <a target="_blank" href="marketplace-demo.html"
                    >marketplace</a
                  >
                </li>
            ...
            <li>
              <a href="category-page.html"> Clothing</a>
              <ul>
            ...
            <li>
              <a href="category-page.html"> electronics</a>
              <ul>
                <li>
            ...
            <li>
              <a href="category-page.html"> basics</a>
              <ul>
                <li>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="product-page(image-outside).html">image outside</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li>
                  <a href="product-page(left-image).html">thumbnail left</a>
                </li>
                <li>
                  <a href="product-page(right-image).html">thumbnail right</a>
                </li>
                <li>
                  <a href="product-page(image-outside).html">thubnail bottom</a>
                </li>
              </ul>
            </li>
            ...
            <li>
              <a href="product-page(bundle).html">
                bundle<span class="new-tag">new</span></a
              >
            </li>
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="product-page(right-image).html">order history</a>
                </li>
            ...
            <li><a href="search.html"> site map</a></li>
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="masonary-fullwidth.html">masonry full width</a>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="element-product-slider.html">product slider</a>
                </li>
                <li><a href="element-no_slider.html">no slider</a></li>
                <li>
                  <a href="element-mulitiple_slider.html">multi slider</a>
                </li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="email-order-success-two.html">order success 2</a>
                </li>
