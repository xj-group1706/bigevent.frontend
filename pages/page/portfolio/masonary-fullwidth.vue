<template>
  <Header />
  <div>
    <WidgetsBreadcrumbs title="Mesonary Fullwidth Portfolio" />
            ...
            <div class="filter-container isotopeFilters">
              <ul class="list-inline filter">
                <li :class="{ active: isActive('all') }">
                  <a href="javascript:void(0)" @click="updateFilter('all')"
                    >All</a
                  >
                </li>
                <li :class="{ active: isActive('fashion') }">
                  <a href="javascript:void(0)" @click="updateFilter('fashion')"
                    >Fashion</a
                  >
                </li>
                <li :class="{ active: isActive('bags') }">
                  <a href="javascript:void(0)" @click="updateFilter('bags')"
                    >Bags</a
                  >
                </li>
                <li :class="{ active: isActive('shoes') }">
                  <a href="javascript:void(0)" @click="updateFilter('shoes')"
                    >Shoes</a
                  >
                </li>
                <li :class="{ active: isActive('watch') }">
                  <a href="javascript:void(0)" @click="updateFilter('watch')"
                    >Watch</a
                  >
                </li>
              </ul>
    ...
    <section
      class="portfolio-section portfolio-padding pt-0 port-col zoom-gallery"
    >
      <div class="container-fluid">
