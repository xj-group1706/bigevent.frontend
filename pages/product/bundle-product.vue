            ...
            <div class="col-lg-6 rtl-text">
              <div class="product-right">
                ...
                <h4 v-if="getDetail.sale">
                  <del
                    >{{ curr.symbol
                    }}{{ (getDetail.price * curr.curr).toFixed(2) }}</del
                  >
                  <span>{{ getDetail.discount }}% off</span>
                </h4>
                <h3 v-if="getDetail.sale">
                  {{ curr.symbol }}{{ discountedPrice(getDetail) }}
                </h3>
                <h3 v-else>
                  {{ curr.symbol
                  }}{{ (getDetail.price * curr.curr).toFixed(2) }}
                </h3>
                    ...
                    <div class="bundle_detail">
                      <div class="theme_checkbox">
                        <label
                          ...
                          <span class="price_product">$55</span>
                          <input type="checkbox" checked="checked" />
                          <span class="checkmark"></span>
                        </label>
                        <label
                          >black long skirt
                          <span class="price_product">$20</span>
                          <input type="checkbox" checked="checked" />
                          <span class="checkmark"></span>
                        </label>
                        <label
                          >women heeled boots
                          <span class="price_product">$15</span>
                          <input type="checkbox" checked="checked" />
                          <span class="checkmark"></span>
                        </label>
                        <a href="#" class="btn btn-solid btn-xs"
                          >buy this bundle</a
                        >
                      </div>
                    </div>
            ...
            <div class="modal-body p-0">
              <div class="bg-white position-relative">
                <div class="modal-header position-relative">
                  ...
                  <button
                    class="close btn-close background-none"
                    type="button"
